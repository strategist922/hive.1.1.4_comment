...
import org.apache.hadoop.hive.service.TCommandProcessorResponse;
...
public class HiveStatement implements java.sql.Statement {
  ...
  private static final long CHECKFINISH_INTERVAL = 1000;
  ...
  public ResultSet executeQuery(String sql) throws SQLException {
    ...
    try {
      ...
      client.start(sql);
      while (true) {
        TCommandProcessorResponse response = client.getResponse();
        if (response.isReady()) {
        ...
        Thread.sleep(CHECKFINISH_INTERVAL);
      }
    } catch (HiveServerException e) {
