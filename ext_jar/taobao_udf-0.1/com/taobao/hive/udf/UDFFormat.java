...
public class UDFFormat extends UDF
{
  public Text evaluate(DoubleWritable d, Text format)
  {
    if (d == null)
      return null;
    return new Text(String.format(format.toString(), new Object[] { Double.valueOf(d.get()) }));
  }

  public Text evaluate(LongWritable l, Text format) {
    if (l == null)
      return null;
    return new Text(String.format(format.toString(), new Object[] { Long.valueOf(l.get()) }));
  }

  public Text evaluate(IntWritable i, Text format) {
    if (i == null)
      return null;
    return new Text(String.format(format.toString(), new Object[] { Integer.valueOf(i.get()) }));
  }
