...
class User {
 public:
  ...
  static const char* ascii_fingerprint; // = "28F311E9368FA26A8D723D360F800E5E";
  static const uint8_t binary_fingerprint[16]; // = {0x28,0xF3,0x11,0xE9,0x36,0x8F,0xA2,0x6A,0x8D,0x72,0x3D,0x36,0x0F,0x80,0x0E,0x5E};

  User() : name(""), password(""), select_priv(0), insert_priv(0), create_priv(0), drop_priv(0), grant_priv(0), alter_priv(0), create_user_priv(0), super_priv(0) {
  }
  ...
  bool grant_priv;
  bool alter_priv;
  bool create_user_priv;
  bool super_priv;

  struct __isset {
    __isset() : name(false), password(false), select_priv(false), insert_priv(false), create_priv(false), drop_priv(false), grant_priv(false), alter_priv(false), create_user_priv(false), super_priv(false) {}
    bool name;
    bool password;
    bool select_priv;
    bool insert_priv;
  ...
  bool operator == (const User & rhs) const
  {
    ...
    if (!(password == rhs.password))
      return false;
    if (!(select_priv == rhs.select_priv))
      return false;
    if (!(insert_priv == rhs.insert_priv))
      return false;
    if (!(create_priv == rhs.create_priv))
      return false;
    if (!(drop_priv == rhs.drop_priv))
      return false;
    if (!(grant_priv == rhs.grant_priv))
      return false;
    if (!(alter_priv == rhs.alter_priv))
      return false;
    if (!(create_user_priv == rhs.create_user_priv))
      return false;
    if (!(super_priv == rhs.super_priv))
      return false;
    return true;
  }
  bool operator != (const User &rhs) const {
...
class DbPriv {
 public:
  ...
  static const char* ascii_fingerprint; // = "A6804841256D778735C81723757A9C8C";
  static const uint8_t binary_fingerprint[16]; // = {0xA6,0x80,0x48,0x41,0x25,0x6D,0x77,0x87,0x35,0xC8,0x17,0x23,0x75,0x7A,0x9C,0x8C};

  DbPriv() : userName(""), dbName(""), select_priv(0), insert_priv(0), drop_priv(0), grant_priv(0), alter_priv(0), create_priv(0) {
  }

  virtual ~DbPriv() throw() {}
  ...
  struct __isset {
    __isset() : userName(false), dbName(false), select_priv(false), insert_priv(false), drop_priv(false), grant_priv(false), alter_priv(false), create_priv(false) {}
    bool userName;
    bool dbName;
    bool select_priv;
    bool insert_priv;
  ...
  bool operator == (const DbPriv & rhs) const
  {
  ...
  bool operator < (const DbPriv & ) const;
...
class TbPriv {
 public:
  ...
  static const char* ascii_fingerprint; // = "F25C3960000AE453B5383F597586F507";
  static const uint8_t binary_fingerprint[16]; // = {0xF2,0x5C,0x39,0x60,0x00,0x0A,0xE4,0x53,0xB5,0x38,0x3F,0x59,0x75,0x86,0xF5,0x07};

  TbPriv() : userName(""), dbName(""), tbName(""), grantor(""), timeStamp(0), select_priv(0), insert_priv(0), drop_priv(0), grant_priv(0), alter_priv(0) {
  }

  virtual ~TbPriv() throw() {}
  ...
  struct __isset {
    __isset() : userName(false), dbName(false), tbName(false), grantor(false), timeStamp(false), select_priv(false), insert_priv(false), drop_priv(false), grant_priv(false), alter_priv(false) {}
    bool userName;
    bool dbName;
    bool tbName;
    bool grantor;
  ...
  bool operator == (const TbPriv & rhs) const
  {
    if (!(userName == rhs.userName))
      return false;
    if (!(dbName == rhs.dbName))
  ...
  bool operator < (const TbPriv & ) const;
