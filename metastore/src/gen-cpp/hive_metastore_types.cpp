...
const char* User::ascii_fingerprint = "28F311E9368FA26A8D723D360F800E5E";
const uint8_t User::binary_fingerprint[16] = {0x28,0xF3,0x11,0xE9,0x36,0x8F,0xA2,0x6A,0x8D,0x72,0x3D,0x36,0x0F,0x80,0x0E,0x5E};
...
uint32_t User::read(apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->select_priv);
      ...
      case 4:
        if (ftype == apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->insert_priv);
      ...
      case 5:
        if (ftype == apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->create_priv);
      ...
      case 6:
        if (ftype == apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->drop_priv);
      ...
      case 7:
        if (ftype == apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->grant_priv);
      ...
      case 8:
        if (ftype == apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->alter_priv);
      ...
      case 9:
        if (ftype == apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->create_user_priv);
      ...
      case 10:
        if (ftype == apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->super_priv);
...
uint32_t User::write(apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("select_priv", apache::thrift::protocol::T_BOOL, 3);
  xfer += oprot->writeBool(this->select_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("insert_priv", apache::thrift::protocol::T_BOOL, 4);
  xfer += oprot->writeBool(this->insert_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("create_priv", apache::thrift::protocol::T_BOOL, 5);
  xfer += oprot->writeBool(this->create_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("drop_priv", apache::thrift::protocol::T_BOOL, 6);
  xfer += oprot->writeBool(this->drop_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("grant_priv", apache::thrift::protocol::T_BOOL, 7);
  xfer += oprot->writeBool(this->grant_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("alter_priv", apache::thrift::protocol::T_BOOL, 8);
  xfer += oprot->writeBool(this->alter_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("create_user_priv", apache::thrift::protocol::T_BOOL, 9);
  xfer += oprot->writeBool(this->create_user_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("super_priv", apache::thrift::protocol::T_BOOL, 10);
  xfer += oprot->writeBool(this->super_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
  return xfer;
...
const char* DbPriv::ascii_fingerprint = "A6804841256D778735C81723757A9C8C";
const uint8_t DbPriv::binary_fingerprint[16] = {0xA6,0x80,0x48,0x41,0x25,0x6D,0x77,0x87,0x35,0xC8,0x17,0x23,0x75,0x7A,0x9C,0x8C};

uint32_t DbPriv::read(apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DbPriv::write(apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("DbPriv");
  ...
  xfer += oprot->writeBool(this->insert_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("drop_priv", apache::thrift::protocol::T_BOOL, 5);
  xfer += oprot->writeBool(this->drop_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("grant_priv", apache::thrift::protocol::T_BOOL, 6);
  xfer += oprot->writeBool(this->grant_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("alter_priv", apache::thrift::protocol::T_BOOL, 7);
  xfer += oprot->writeBool(this->alter_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("create_priv", apache::thrift::protocol::T_BOOL, 8);
  xfer += oprot->writeBool(this->create_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
const char* TbPriv::ascii_fingerprint = "F25C3960000AE453B5383F597586F507";
const uint8_t TbPriv::binary_fingerprint[16] = {0xF2,0x5C,0x39,0x60,0x00,0x0A,0xE4,0x53,0xB5,0x38,0x3F,0x59,0x75,0x86,0xF5,0x07};

uint32_t TbPriv::read(apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t TbPriv::write(apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("TbPriv");
  xfer += oprot->writeFieldBegin("userName", apache::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeString(this->userName);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("dbName", apache::thrift::protocol::T_STRING, 2);
  ...
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("select_priv", apache::thrift::protocol::T_BOOL, 6);
  xfer += oprot->writeBool(this->select_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("insert_priv", apache::thrift::protocol::T_BOOL, 7);
  xfer += oprot->writeBool(this->insert_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("drop_priv", apache::thrift::protocol::T_BOOL, 8);
  xfer += oprot->writeBool(this->drop_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("grant_priv", apache::thrift::protocol::T_BOOL, 9);
  xfer += oprot->writeBool(this->grant_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldBegin("alter_priv", apache::thrift::protocol::T_BOOL, 10);
  xfer += oprot->writeBool(this->alter_priv);
  xfer += oprot->writeFieldEnd();
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
