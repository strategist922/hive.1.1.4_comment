...
class User:
  ...
  thrift_spec = (
    ...
    (3, TType.BOOL, 'select_priv', None, None, ), # 3
    (4, TType.BOOL, 'insert_priv', None, None, ), # 4
    (5, TType.BOOL, 'create_priv', None, None, ), # 5
    (6, TType.BOOL, 'drop_priv', None, None, ), # 6
    (7, TType.BOOL, 'grant_priv', None, None, ), # 7
    (8, TType.BOOL, 'alter_priv', None, None, ), # 8
    (9, TType.BOOL, 'create_user_priv', None, None, ), # 9
    (10, TType.BOOL, 'super_priv', None, None, ), # 10
  )

  def __init__(self, name=None, password=None, select_priv=None, insert_priv=None, create_priv=None, drop_priv=None, grant_priv=None, alter_priv=None, create_user_priv=None, super_priv=None,):
    self.name = name
    self.password = password
    self.select_priv = select_priv
    self.insert_priv = insert_priv
    self.create_priv = create_priv
    self.drop_priv = drop_priv
    self.grant_priv = grant_priv
    self.alter_priv = alter_priv
    self.create_user_priv = create_user_priv
    self.super_priv = super_priv
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.BOOL:
          self.select_priv = iprot.readBool();
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.BOOL:
          self.insert_priv = iprot.readBool();
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.BOOL:
          self.create_priv = iprot.readBool();
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.BOOL:
          self.drop_priv = iprot.readBool();
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.BOOL:
          self.grant_priv = iprot.readBool();
        else:
          iprot.skip(ftype)
      elif fid == 8:
        if ftype == TType.BOOL:
          self.alter_priv = iprot.readBool();
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.BOOL:
          self.create_user_priv = iprot.readBool();
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.BOOL:
          self.super_priv = iprot.readBool();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.password != None:
      ...
      oprot.writeFieldEnd()
    if self.select_priv != None:
      oprot.writeFieldBegin('select_priv', TType.BOOL, 3)
      oprot.writeBool(self.select_priv)
      oprot.writeFieldEnd()
    if self.insert_priv != None:
      oprot.writeFieldBegin('insert_priv', TType.BOOL, 4)
      oprot.writeBool(self.insert_priv)
      oprot.writeFieldEnd()
    if self.create_priv != None:
      oprot.writeFieldBegin('create_priv', TType.BOOL, 5)
      oprot.writeBool(self.create_priv)
      oprot.writeFieldEnd()
    if self.drop_priv != None:
      oprot.writeFieldBegin('drop_priv', TType.BOOL, 6)
      oprot.writeBool(self.drop_priv)
      oprot.writeFieldEnd()
    if self.grant_priv != None:
      oprot.writeFieldBegin('grant_priv', TType.BOOL, 7)
      oprot.writeBool(self.grant_priv)
      oprot.writeFieldEnd()
    if self.alter_priv != None:
      oprot.writeFieldBegin('alter_priv', TType.BOOL, 8)
      oprot.writeBool(self.alter_priv)
      oprot.writeFieldEnd()
    if self.create_user_priv != None:
      oprot.writeFieldBegin('create_user_priv', TType.BOOL, 9)
      oprot.writeBool(self.create_user_priv)
      oprot.writeFieldEnd()
    if self.super_priv != None:
      oprot.writeFieldBegin('super_priv', TType.BOOL, 10)
      oprot.writeBool(self.super_priv)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class DbPriv:
  ...
  thrift_spec = (
    ...
    (3, TType.BOOL, 'select_priv', None, None, ), # 3
    (4, TType.BOOL, 'insert_priv', None, None, ), # 4
    (5, TType.BOOL, 'drop_priv', None, None, ), # 5
    (6, TType.BOOL, 'grant_priv', None, None, ), # 6
    (7, TType.BOOL, 'alter_priv', None, None, ), # 7
    (8, TType.BOOL, 'create_priv', None, None, ), # 8
  )

  def __init__(self, userName=None, dbName=None, select_priv=None, insert_priv=None, drop_priv=None, grant_priv=None, alter_priv=None, create_priv=None,):
  ...
  def write(self, oprot):
    ...
    if self.insert_priv != None:
      ...
      oprot.writeFieldEnd()
    if self.drop_priv != None:
      oprot.writeFieldBegin('drop_priv', TType.BOOL, 5)
      oprot.writeBool(self.drop_priv)
      oprot.writeFieldEnd()
    if self.grant_priv != None:
      oprot.writeFieldBegin('grant_priv', TType.BOOL, 6)
      oprot.writeBool(self.grant_priv)
      oprot.writeFieldEnd()
    if self.alter_priv != None:
      oprot.writeFieldBegin('alter_priv', TType.BOOL, 7)
      oprot.writeBool(self.alter_priv)
      oprot.writeFieldEnd()
    if self.create_priv != None:
      oprot.writeFieldBegin('create_priv', TType.BOOL, 8)
      oprot.writeBool(self.create_priv)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class TbPriv:
  ...
  thrift_spec = (
    ...
    (6, TType.BOOL, 'select_priv', None, None, ), # 6
    (7, TType.BOOL, 'insert_priv', None, None, ), # 7
    (8, TType.BOOL, 'drop_priv', None, None, ), # 8
    (9, TType.BOOL, 'grant_priv', None, None, ), # 9
    (10, TType.BOOL, 'alter_priv', None, None, ), # 10
  )

  def __init__(self, userName=None, dbName=None, tbName=None, grantor=None, timeStamp=None, select_priv=None, insert_priv=None, drop_priv=None, grant_priv=None, alter_priv=None,):
    self.userName = userName
    self.dbName = dbName
    self.tbName = tbName
  ...
  def write(self, oprot):
    ...
    if self.timeStamp != None:
      ...
      oprot.writeFieldEnd()
    if self.select_priv != None:
      oprot.writeFieldBegin('select_priv', TType.BOOL, 6)
      oprot.writeBool(self.select_priv)
      oprot.writeFieldEnd()
    if self.insert_priv != None:
      oprot.writeFieldBegin('insert_priv', TType.BOOL, 7)
      oprot.writeBool(self.insert_priv)
      oprot.writeFieldEnd()
    if self.drop_priv != None:
      oprot.writeFieldBegin('drop_priv', TType.BOOL, 8)
      oprot.writeBool(self.drop_priv)
      oprot.writeFieldEnd()
    if self.grant_priv != None:
      oprot.writeFieldBegin('grant_priv', TType.BOOL, 9)
      oprot.writeBool(self.grant_priv)
      oprot.writeFieldEnd()
    if self.alter_priv != None:
      oprot.writeFieldBegin('alter_priv', TType.BOOL, 10)
      oprot.writeBool(self.alter_priv)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
