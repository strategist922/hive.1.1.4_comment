...
public interface RawStore extends Configurable {
  ...
  public boolean createUser(User user) throws InvalidObjectException, MetaException;

  //public boolean createUser(String name, byte[] password);

  public boolean dropUser(String userName) throws NoSuchObjectException, MetaException;

  public void alterUser(String userName, User newUser) throws InvalidObjectException, NoSuchObjectException, MetaException;

  public DbPriv getDbPriv(String name, String db) throws NoSuchObjectException, MetaException;

  public List<DbPriv> getDbPrivs(String db) throws NoSuchObjectException, MetaException;

  public boolean grantDbPriv(DbPriv dbPriv) throws MetaException, InvalidObjectException;

  public void alterDbPriv(String userName, String db, DbPriv newDbPriv) throws InvalidObjectException, NoSuchObjectException, MetaException;

  public boolean revokeDbPriv(String userName, String db) throws InvalidObjectException, NoSuchObjectException, MetaException;
  ...
  public void alterTbPriv(String userName, String db, String tbName, TbPriv newTbPriv) throws InvalidObjectException, NoSuchObjectException, MetaException;

  public boolean revokeTbPriv(String userName, String db, String tbName) throws InvalidObjectException, NoSuchObjectException, MetaException;
