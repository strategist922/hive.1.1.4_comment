...
class metastore_User {
  ...
  public $select_priv = null;
  public $insert_priv = null;
  public $create_priv = null;
  public $drop_priv = null;
  public $grant_priv = null;
  public $alter_priv = null;
  public $create_user_priv = null;
  public $super_priv = null;
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['select_priv'])) {
        $this->select_priv = $vals['select_priv'];
      }
      if (isset($vals['insert_priv'])) {
        $this->insert_priv = $vals['insert_priv'];
      }
      if (isset($vals['create_priv'])) {
        $this->create_priv = $vals['create_priv'];
      }
      if (isset($vals['drop_priv'])) {
        $this->drop_priv = $vals['drop_priv'];
      }
      if (isset($vals['grant_priv'])) {
        $this->grant_priv = $vals['grant_priv'];
      }
      if (isset($vals['alter_priv'])) {
        $this->alter_priv = $vals['alter_priv'];
      }
      if (isset($vals['create_user_priv'])) {
        $this->create_user_priv = $vals['create_user_priv'];
      }
      if (isset($vals['super_priv'])) {
        $this->super_priv = $vals['super_priv'];
      }
    }
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->select_priv);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 4:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->insert_priv);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 5:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->create_priv);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 6:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->drop_priv);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 7:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->grant_priv);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 8:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->alter_priv);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 9:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->create_user_priv);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
        case 10:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->super_priv);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->select_priv !== null) {
      $xfer += $output->writeFieldBegin('select_priv', TType::BOOL, 3);
      $xfer += $output->writeBool($this->select_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->insert_priv !== null) {
      $xfer += $output->writeFieldBegin('insert_priv', TType::BOOL, 4);
      $xfer += $output->writeBool($this->insert_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->create_priv !== null) {
      $xfer += $output->writeFieldBegin('create_priv', TType::BOOL, 5);
      $xfer += $output->writeBool($this->create_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->drop_priv !== null) {
      $xfer += $output->writeFieldBegin('drop_priv', TType::BOOL, 6);
      $xfer += $output->writeBool($this->drop_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->grant_priv !== null) {
      $xfer += $output->writeFieldBegin('grant_priv', TType::BOOL, 7);
      $xfer += $output->writeBool($this->grant_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->alter_priv !== null) {
      $xfer += $output->writeFieldBegin('alter_priv', TType::BOOL, 8);
      $xfer += $output->writeBool($this->alter_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->create_user_priv !== null) {
      $xfer += $output->writeFieldBegin('create_user_priv', TType::BOOL, 9);
      $xfer += $output->writeBool($this->create_user_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->super_priv !== null) {
      $xfer += $output->writeFieldBegin('super_priv', TType::BOOL, 10);
      $xfer += $output->writeBool($this->super_priv);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
...
class metastore_DbPriv {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('DbPriv');
    ...
    if ($this->drop_priv !== null) {
      $xfer += $output->writeFieldBegin('drop_priv', TType::BOOL, 5);
      $xfer += $output->writeBool($this->drop_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->grant_priv !== null) {
      $xfer += $output->writeFieldBegin('grant_priv', TType::BOOL, 6);
      $xfer += $output->writeBool($this->grant_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->alter_priv !== null) {
      $xfer += $output->writeFieldBegin('alter_priv', TType::BOOL, 7);
      $xfer += $output->writeBool($this->alter_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->create_priv !== null) {
      $xfer += $output->writeFieldBegin('create_priv', TType::BOOL, 8);
      $xfer += $output->writeBool($this->create_priv);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
...
class metastore_TbPriv {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('TbPriv');
    if ($this->userName !== null) {
      $xfer += $output->writeFieldBegin('userName', TType::STRING, 1);
      $xfer += $output->writeString($this->userName);
      $xfer += $output->writeFieldEnd();
    ...
    if ($this->select_priv !== null) {
      $xfer += $output->writeFieldBegin('select_priv', TType::BOOL, 6);
      $xfer += $output->writeBool($this->select_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->insert_priv !== null) {
      $xfer += $output->writeFieldBegin('insert_priv', TType::BOOL, 7);
      $xfer += $output->writeBool($this->insert_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->drop_priv !== null) {
      $xfer += $output->writeFieldBegin('drop_priv', TType::BOOL, 8);
      $xfer += $output->writeBool($this->drop_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->grant_priv !== null) {
      $xfer += $output->writeFieldBegin('grant_priv', TType::BOOL, 9);
      $xfer += $output->writeBool($this->grant_priv);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->alter_priv !== null) {
      $xfer += $output->writeFieldBegin('alter_priv', TType::BOOL, 10);
      $xfer += $output->writeBool($this->alter_priv);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
