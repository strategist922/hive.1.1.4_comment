...
service ThriftHiveMetastore extends fb303.FacebookService
{
  ...
  bool create_user(1:User user) throws(1:AlreadyExistsException o1, 2:InvalidObjectException o2, 3:MetaException o3)
  User get_user(1:string name) throws(1:NoSuchObjectException o1, 2:MetaException o2)
  void alter_user(1:string userName, 2:User newUser) throws(1:InvalidOperationException o1, 2:MetaException o2, 3:NoSuchObjectException o3)
  bool drop_user(1:string userName) throws(1:NoSuchObjectException o1, 2:MetaException o2, 3:InvalidOperationException o3)
  bool grant_dbpriv(1:DbPriv dbPriv) throws(1:AlreadyExistsException o1, 2:MetaException o2, 3:InvalidObjectException o3)
  DbPriv get_dbpriv(1:string name, 2:string db) throws(1:MetaException o1, 2: NoSuchObjectException o2)
  list<DbPriv> get_dbprivs(1:string db) throws(1:MetaException o1, 2: NoSuchObjectException o2)
  void alter_dbpriv(1:string userName, 2:string db, 3:DbPriv newDbPriv) throws(1:InvalidObjectException o1, 2:NoSuchObjectException o2, 3:MetaException o3, 4:InvalidOperationException o4)
  bool revoke_dbpriv(1:string userName, 2:string db) throws(1:MetaException o1, 2: NoSuchObjectException o2, 3: InvalidObjectException o3)
  TbPriv get_tbpriv(1:string userName, 2:string db, 3:string tb) throws(1:MetaException o1, 2:NoSuchObjectException o2)
  list<TbPriv> get_tbprivs(1:string db, 2:string tb) throws(1:MetaException o1, 2: NoSuchObjectException o2)
  bool revoke_tbpriv(1:string userName, 2:string db, 3:string tbName) throws(1:MetaException o1, 2: NoSuchObjectException o2, 3: InvalidObjectException o3)
  bool grant_tbpriv(1:TbPriv tbPriv) throws(1:InvalidObjectException o1, 2:MetaException o2, 3:AlreadyExistsException o3)
  void alter_tbpriv(1:string userName, 2:string db, 3:string tbName, 4:TbPriv newTbPriv) throws(1:InvalidObjectException o1, 2:NoSuchObjectException o2, 3:MetaException o3, 4:InvalidOperationException o4)
