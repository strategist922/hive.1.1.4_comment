...
class Client(hive_metastore.ThriftHiveMetastore.Client, Iface):
  ...
  def getHiveQueryInfo(self, ):
    self.send_getHiveQueryInfo()
    return self.recv_getHiveQueryInfo()

  def send_getHiveQueryInfo(self, ):
    self._oprot.writeMessageBegin('getHiveQueryInfo', TMessageType.CALL, self._seqid)
    args = getHiveQueryInfo_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getHiveQueryInfo(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = getHiveQueryInfo_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success != None:
      return result.success
    if result.ex != None:
      raise result.ex
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getHiveQueryInfo failed: unknown result");
  ...
  def start(self, query):
    ...
    Parameters:
     - query
    """
    self.send_start(query)
    self.recv_start()

  def send_start(self, query):
  ...
  def getResponse(self, ):
    self.send_getResponse()
    return self.recv_getResponse()

  def send_getResponse(self, ):
    self._oprot.writeMessageBegin('getResponse', TMessageType.CALL, self._seqid)
    args = getResponse_args()
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_getResponse(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = getResponse_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success != None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT, "getResponse failed: unknown result");
...
class Processor(hive_metastore.ThriftHiveMetastore.Processor, Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["getHiveQueryInfo"] = Processor.process_getHiveQueryInfo
    self._processMap["killJob"] = Processor.process_killJob
    self._processMap["start"] = Processor.process_start
    self._processMap["getResponse"] = Processor.process_getResponse
  ...
  def process_getHiveQueryInfo(self, seqid, iprot, oprot):
    args = getHiveQueryInfo_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getHiveQueryInfo_result()
    try:
      result.success = self._handler.getHiveQueryInfo()
    except HiveServerException, ex:
      result.ex = ex
    oprot.writeMessageBegin("getHiveQueryInfo", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_start(self, seqid, iprot, oprot):
    ...
    result = start_result()
    try:
      self._handler.start(args.query)
    except HiveServerException, ex:
      result.ex = ex
  ...
  def process_getResponse(self, seqid, iprot, oprot):
    args = getResponse_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = getResponse_result()
    result.success = self._handler.getResponse()
    oprot.writeMessageBegin("getResponse", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class getHiveQueryInfo_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getHiveQueryInfo_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class getHiveQueryInfo_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TQueryInfo, TQueryInfo.thrift_spec), None, ), # 0
    (1, TType.STRUCT, 'ex', (HiveServerException, HiveServerException.thrift_spec), None, ), # 1
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getHiveQueryInfo_result')
    if self.success != None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
...
class getResponse_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getResponse_args')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class getResponse_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TCommandProcessorResponse, TCommandProcessorResponse.thrift_spec), None, ), # 0
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = TCommandProcessorResponse()
          self.success.read(iprot)
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('getResponse_result')
    if self.success != None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
