...
public class ThriftHive {
  ...
  public static class Client extends org.apache.hadoop.hive.metastore.api.ThriftHiveMetastore.Client implements Iface {
    ...
    public TQueryInfo getHiveQueryInfo() throws HiveServerException, TException
    {
      send_getHiveQueryInfo();
      return recv_getHiveQueryInfo();
    }

    public void send_getHiveQueryInfo() throws TException
    {
      oprot_.writeMessageBegin(new TMessage("getHiveQueryInfo", TMessageType.CALL, seqid_));
      getHiveQueryInfo_args args = new getHiveQueryInfo_args();
      args.write(oprot_);
      oprot_.writeMessageEnd();
      oprot_.getTransport().flush();
    }

    public TQueryInfo recv_getHiveQueryInfo() throws HiveServerException, TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
      ...
      getHiveQueryInfo_result result = new getHiveQueryInfo_result();
      result.read(iprot_);
      iprot_.readMessageEnd();
      if (result.isSetSuccess()) {
        return result.success;
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT, "getHiveQueryInfo failed: unknown result");
    }
    ...
    public void recv_killJob() throws HiveServerException, TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
    ...
    public void send_start(String query) throws TException
    {
    ...
    public void recv_start() throws HiveServerException, TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
    ...
    public void send_getResponse() throws TException
    {
      oprot_.writeMessageBegin(new TMessage("getResponse", TMessageType.CALL, seqid_));
    ...
    public TCommandProcessorResponse recv_getResponse() throws TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT, "getResponse failed: unknown result");
    }
  ...
  public static class Processor extends org.apache.hadoop.hive.metastore.api.ThriftHiveMetastore.Processor implements TProcessor {
    ...
    public Processor(Iface iface)
    {
      ...
      processMap_.put("getHiveQueryInfo", new getHiveQueryInfo());
      processMap_.put("killJob", new killJob());
      processMap_.put("start", new start());
      processMap_.put("getResponse", new getResponse());
    ...
    private class getHiveQueryInfo implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        getHiveQueryInfo_args args = new getHiveQueryInfo_args();
        args.read(iprot);
        ...
        getHiveQueryInfo_result result = new getHiveQueryInfo_result();
        try {
          result.success = iface_.getHiveQueryInfo();
        } catch (HiveServerException ex) {
          result.ex = ex;
        } catch (Throwable th) {
          LOGGER.error("Internal error processing getHiveQueryInfo", th);
          TApplicationException x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing getHiveQueryInfo");
          oprot.writeMessageBegin(new TMessage("getHiveQueryInfo", TMessageType.EXCEPTION, seqid));
          x.write(oprot);
          oprot.writeMessageEnd();
          oprot.getTransport().flush();
          return;
        }
        oprot.writeMessageBegin(new TMessage("getHiveQueryInfo", TMessageType.REPLY, seqid));
        result.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
      }
    ...
    private class start implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        ...
        start_result result = new start_result();
        try {
          iface_.start(args.query);
        } catch (HiveServerException ex) {
          result.ex = ex;
        } catch (Throwable th) {
          LOGGER.error("Internal error processing start", th);
          TApplicationException x = new TApplicationException(TApplicationException.INTERNAL_ERROR, "Internal error processing start");
    ...
    private class getResponse implements ProcessFunction {
      public void process(int seqid, TProtocol iprot, TProtocol oprot) throws TException
      {
        getResponse_args args = new getResponse_args();
        args.read(iprot);
        iprot.readMessageEnd();
        getResponse_result result = new getResponse_result();
        result.success = iface_.getResponse();
        oprot.writeMessageBegin(new TMessage("getResponse", TMessageType.REPLY, seqid));
        result.write(oprot);
        oprot.writeMessageEnd();
        oprot.getTransport().flush();
      }
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new ArrayList<String>(_list15.size);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (String _iter18 : this.success)          {
  ...
  public static class fetchAll_result implements TBase, java.io.Serializable, Cloneable   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new ArrayList<String>(_list19.size);
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.success.size()));
          for (String _iter22 : this.success)          {
  ...
  public static class getHiveQueryInfo_args implements TBase, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("getHiveQueryInfo_args");

    public static final Map<Integer, FieldMetaData> metaDataMap = Collections.unmodifiableMap(new HashMap<Integer, FieldMetaData>() {{
    }});

    static {
      FieldMetaData.addStructMetaDataMap(getHiveQueryInfo_args.class, metaDataMap);
    }

    public getHiveQueryInfo_args() {
    }

    /**
     * Performs a deep copy on <i>other</i>.
     */
    public getHiveQueryInfo_args(getHiveQueryInfo_args other) {
    }

    @Override
    public getHiveQueryInfo_args clone() {
      return new getHiveQueryInfo_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getHiveQueryInfo_args)
        return this.equals((getHiveQueryInfo_args)that);
      return false;
    }

    public boolean equals(getHiveQueryInfo_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getHiveQueryInfo_args(");
      boolean first = true;
  ...
  public static class getHiveQueryInfo_result implements TBase, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("getHiveQueryInfo_result");
    private static final TField SUCCESS_FIELD_DESC = new TField("success", TType.STRUCT, (short)0);
    private static final TField EX_FIELD_DESC = new TField("ex", TType.STRUCT, (short)1);

    private TQueryInfo success;
    public static final int SUCCESS = 0;
    private HiveServerException ex;
    public static final int EX = 1;
    ...
    public static final Map<Integer, FieldMetaData> metaDataMap = Collections.unmodifiableMap(new HashMap<Integer, FieldMetaData>() {{
      put(SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT, 
          new StructMetaData(TType.STRUCT, TQueryInfo.class)));
      put(EX, new FieldMetaData("ex", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.STRUCT)));
    }});

    static {
      FieldMetaData.addStructMetaDataMap(getHiveQueryInfo_result.class, metaDataMap);
    }

    public getHiveQueryInfo_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getHiveQueryInfo_result(getHiveQueryInfo_result other) {
      if (other.isSetSuccess()) {
        this.success = new TQueryInfo(other.success);
      }
      if (other.isSetEx()) {
        this.ex = new HiveServerException(other.ex);
      }
    ...
    @Override
    public getHiveQueryInfo_result clone() {
      return new getHiveQueryInfo_result(this);
    }

    public TQueryInfo getSuccess() {
      return this.success;
    }

    public void setSuccess(TQueryInfo success) {
      this.success = success;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getHiveQueryInfo_result)
        return this.equals((getHiveQueryInfo_result)that);
      return false;
    }

    public boolean equals(getHiveQueryInfo_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getHiveQueryInfo_result(");
      boolean first = true;
  ...
  public static class getResponse_args implements TBase, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("getResponse_args");

    public static final Map<Integer, FieldMetaData> metaDataMap = Collections.unmodifiableMap(new HashMap<Integer, FieldMetaData>() {{
    }});

    static {
      FieldMetaData.addStructMetaDataMap(getResponse_args.class, metaDataMap);
    }
  ...
  public static class getResponse_result implements TBase, java.io.Serializable, Cloneable   {
    private static final TStruct STRUCT_DESC = new TStruct("getResponse_result");
    private static final TField SUCCESS_FIELD_DESC = new TField("success", TType.STRUCT, (short)0);

    private TCommandProcessorResponse success;
    public static final int SUCCESS = 0;
    ...
    public static final Map<Integer, FieldMetaData> metaDataMap = Collections.unmodifiableMap(new HashMap<Integer, FieldMetaData>() {{
      put(SUCCESS, new FieldMetaData("success", TFieldRequirementType.DEFAULT, 
          new StructMetaData(TType.STRUCT, TCommandProcessorResponse.class)));
    }});

    static {
      FieldMetaData.addStructMetaDataMap(getResponse_result.class, metaDataMap);
    }
    ...
    public getResponse_result(
      TCommandProcessorResponse success)
    {
      this();
      this.success = success;
    }
    ...
    public getResponse_result(getResponse_result other) {
      if (other.isSetSuccess()) {
        this.success = new TCommandProcessorResponse(other.success);
      }
    }

    @Override
    public getResponse_result clone() {
      return new getResponse_result(this);
    }

    public TCommandProcessorResponse getSuccess() {
      return this.success;
    }

    public void setSuccess(TCommandProcessorResponse success) {
      this.success = success;
    }
    ...
    public void setFieldValue(int fieldID, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((TCommandProcessorResponse)value);
        }
        break;
