...
public class Context {
  private Path resFile;//用到了explain时候结果输出的缓存文件
  private Path resDir;
  ...
  public void backupOriginalMasters(String originalTracker, String originalName) {
    this.originalTracker = originalTracker;
    this.originalName = originalName;
  }

  public void restoreOriginalMasters() {
    ...
    if (originalName != null) {
      HiveConf.setVar(conf, HiveConf.ConfVars.HADOOPNN, originalName);
      originalName = null;
    }
  }
  ...
  public Map<String, String> getFsScratchDirs() {
