...
public class CombineHiveInputFormat<K extends WritableComparable, V extends Writable>
  ...
  public InputSplit[] getSplits(JobConf job, int numSplits) throws IOException {
    ...
    for (Path path : paths) {
      ...
      // All semi-support CombineFileInputFormat hadoop versions (0.17-0.19, not 0.20) by HadoopShims
      // are not affected by MAPREDUCE-1597
      if ((this.mrwork != null && !this.mrwork.getHadoopSupportsSplittable())
          && ShimLoader.getMajorVersion().equals("0.20")
          ) {
