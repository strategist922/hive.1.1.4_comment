...
public final class SemanticAnalyzerFactory {
  ...
  static {
	...
	commandType.put(HiveParser.TOK_CREATEUSER, "CREATEUSER");
	commandType.put(HiveParser.TOK_DROPUSER, "DROPUSER");
	commandType.put(HiveParser.TOK_SETPASSWORD, "SETPASSWORD");
	commandType.put(HiveParser.TOK_GRANT, "GRANT");
	commandType.put(HiveParser.TOK_REVOKE, "REVOKE");
	commandType.put(HiveParser.TOK_SHOWGRANTS, "SHOWGRANTS");
  }
  ...
  public BaseSemanticAnalyzer get(ASTNode tree)
    ...
    if (tree.getToken() == null) {
	  ...
	  case HiveParser.TOK_SETPASSWORD:
        return new UserSemanticAnalyzer(conf);
      case HiveParser.TOK_GRANT:
      case HiveParser.TOK_REVOKE:
	  case HiveParser.TOK_SHOWGRANTS:
        return new DCLSemanticAnalyzer(conf);
      default:
  ...
  public SemanticAnalyzerFactory(HiveConf conf) {
    this.conf = conf;
  }
