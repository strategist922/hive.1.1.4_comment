...
load data local inpath '../data/files/srcbucket200.txt' INTO TABLE gl_src1;
load data local inpath '../data/files/srcbucket201.txt' INTO TABLE gl_src1;
load data local inpath '../data/files/srcbucket202.txt' INTO TABLE gl_src1;
...
load data local inpath '../data/files/srcbucket200.txt' INTO TABLE gl_src_part1 partition(p='12');
load data local inpath '../data/files/srcbucket201.txt' INTO TABLE gl_src_part1 partition(p='12');
load data local inpath '../data/files/srcbucket202.txt' INTO TABLE gl_src_part1 partition(p='12');
